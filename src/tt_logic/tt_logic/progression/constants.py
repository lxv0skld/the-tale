...
# количество времени на каждый уровень считаем по кусочно-заданной функции (это проще, чем подбиать удобную формулу)
...
# формат точки: <уровень, через какое время должен достигаться>
LEVEL_TIME_BASE_POINTS = [(1, 0 * _hours),
                          (2, TIME_ON_FIRST_LEVEL * _hours),
                          (HERO_ABILITY_MAXIMUM, 7 * _days),
